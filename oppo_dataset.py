...
def get_dataset(pa = 'data_/opp.dat'): #/home/ltz/zhaojj/PAMAP2_Dataset/Protocol
...
def gen_dataset(path):
    ...
    corrcoef = np.loadtxt(open("data_/adj_opp.csv","rb"),delimiter=",",skiprows=0)
