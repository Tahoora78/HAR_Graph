...
def get_dataset(pa = 'data_/pamap2.dat'): #/home/ltz/zhaojj/PAMAP2_Dataset/Protocol
...
def gen_dataset(path):
    ...
    corrcoef = np.loadtxt(open("data_/adj_pamap2.csv", "rb"), delimiter=",", skiprows=0)
    print("Loading over...")
